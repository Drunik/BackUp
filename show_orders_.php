...
function show_phone(){
	...
	$.ajax({  
          ...
          url: "http://vtsystem.ru/ast/get_phone.php",  
...
function add_tarif(id_,field_){
	...
	var $id = id_,
	 ...
	 $distance_1 = $("#distance_1"+$id).val(),

	 $distance_2 = $("#distance_2"+$id).val(),
